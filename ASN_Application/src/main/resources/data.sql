...
INSERT INTO employee (RELIGION, PHONE_NUMBER, ID) VALUES ('CHRISTIANITY', '0660123456', 7);

INSERT INTO child (FIRST_NAME, LAST_NAME) VALUES('Lena', 'Raedler');

INSERT INTO task (description, receiver_id, sender_id) VALUES ('Essen mitbringen', 3, 5);
INSERT INTO task (description, receiver_id, sender_id) VALUES ('Essen mitbringen', 2, 5);
INSERT INTO task (description, receiver_id, sender_id) VALUES ('Essen mitbringen', 4, 5);
INSERT INTO task (description, receiver_id, sender_id) VALUES ('Wasserfarben besorgen', 2, 7);
INSERT INTO task (description, receiver_id, sender_id) VALUES ('Zeichenpapier mitbringen', 4, 6);
INSERT INTO task (description, receiver_id, sender_id) VALUES ('Zeichenpapier mitbringen', 3, 6);