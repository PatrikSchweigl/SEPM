 ...
 */
public class CreateAndDeleteHoliday {
	...
	@Test
	public void testCreateAndDeleteHoliday() throws Exception {
		// login
		...
		Thread.sleep(1000);
		driver.findElement(By.id("sheduleForm:important")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("sheduleForm:title")).clear();
		driver.findElement(By.id("sheduleForm:title")).sendKeys("Testfeiertag");
		// save
		driver.findElement(By.id("sheduleForm:addButton")).click();
		Thread.sleep(1000);
		// delete holiday
		driver.findElement(By.xpath("//div[@id='sheduleForm:schedule_container']/div[2]/div/table/tbody/tr/td/div/div/div[5]/div[2]/table/tbody/tr/td[5]/a/div")).click();
		Thread.sleep(1000);
