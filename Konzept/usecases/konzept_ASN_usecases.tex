...
\subsection{Akteure}
 ...
 \subsection{Use-Case Kinderstammblatt einsehen }
  ...
  \begin{itemize}
  	...
  	\item Mindestens ein Kind des Elternteils is in der Kinderkrippe registriert
  \end{itemize}
  ...
  \begin{enumerate}
  	...
  	\item Der Elternteil schlie"sst die Bearbeitung mit einem Klick auf den Button "Best"atigen" ab. 
  \end{enumerate}
