...
\subsection{Akteure}
 ...
 \subsection{Use-Case Eigene Daten bearbeiten}
  ...
  Der Benutzer befindet sich in M2-Grundstellung
	...
	\paragraph{Ausl"oser}
	Der Benutzer klickt auf den Button \dq E-Mail-Benachrichtigungen abbonieren\dq
	\paragraph{Beteiligte Akteure}   \leavevmode \newline
	...
	\paragraph{Schritte}
	\begin{enumerate}
	 	\item Der Benutzer klickt auf den Button \dq E-Mail-Benachrichtigungen abbonieren\dq
